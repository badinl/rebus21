...
{
       0,   100,   100,   108,   119,   130,   135,   140,   150,   161,
     176,   192,   198,   207,   219,   228,   245,   269,   273,   289,
     304,   319,   335,   349,   363,   376,   389,   410,   422,   434,
     446,   458,   470,   482,   487
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "IDENTIFIER", "REL", "TYPE",
  "IF", "ELSE", "WHILE", "PRINT", "'+'", "'-'", "'*'", "'/'", "UMINUS",
  "OR", "AND", "NOT", "';'", "'{'", "'}'", "'('", "')'", "'='", "','",
  "$accept", "prog", "list", "stmt", "M", "N", "print", "assign",
  "decl_ass", "decl", "label", "bool", "expr", YY_NULLPTR
};
#endif
...
static const yytype_int16 yytoknum[] =
{
     ...
     265,    43,    45,    42,    47,   266,   267,   268,   269,    59,
     123,   125,    40,    41,    61,    44
};
# endif
...
{
      50,   -23,     1,    -1,   -31,     8,    50,    22,    24,   -31,
       7,    10,    13,     8,    12,   -31,    51,     5,    63,   -31,
     -31,     8,     8,    70,    54,   -31,    50,   -31,   -31,   -31,
      70,     8,    73,     5,     5,    45,    53,     5,   -31,     2,
       8,     8,     8,     8,   -31,   -31,    70,    12,   -31,   -31,
      55,    30,   -31,   -31,   -31,     8,    57,   -31,    33,    33,
     -31,   -31,   -31,     5,     5,    50,    70,   -31,    62,   -31,
      78,    50,   -31,   -31,   -31,    50,   -31
};
...
{
       0,     0,     0,     0,    12,     0,     0,     0,    12,     4,
       0,     0,     0,     0,    20,    21,    17,     0,     0,    33,
      34,     0,     0,    14,    12,     1,     0,    11,     5,     6,
      15,     0,     0,     0,     0,     0,     0,     0,    32,     0,
       0,     0,     0,     0,     7,     3,    16,    18,    19,    24,
       0,     0,    12,    12,    12,     0,     0,    31,    27,    28,
      29,    30,    25,     0,     0,     0,    26,    12,    22,    23,
       8,     0,    13,    12,    10,     0,     9
};
...
{
      18,    13,    23,    49,    50,    14,    45,    56,    19,    20,
      30,    19,    20,    40,    41,    42,    43,    21,    38,    39,
      21,    17,    25,    33,    -2,    57,    27,    34,    46,    28,
      22,    51,    29,    68,    69,    55,    31,    58,    59,    60,
      61,    40,    41,    42,    43,    70,    42,    43,    63,    64,
      65,    74,    66,    57,     1,    76,     2,     3,    55,     4,
       5,    52,    53,    71,    40,    41,    42,    43,    54,    75,
       6,    52,    53,    52,    53,    44,    32,    47,    62,    53,
      67,    40,    41,    42,    43,    37,    72,    24,    48
};

static const yytype_int8 yycheck[] =
{
       4,    24,     5,    33,    34,     4,    26,    37,     3,     4,
      13,     3,     4,    11,    12,    13,    14,    12,    21,    22,
      12,    22,     0,    18,     0,    23,    19,    22,    31,    19,
      22,    34,    19,    63,    64,     5,    24,    40,    41,    42,
      43,    11,    12,    13,    14,    65,    13,    14,    52,    53,
      54,    71,    55,    23,     4,    75,     6,     7,     5,     9,
      10,    16,    17,    67,    11,    12,    13,    14,    23,    73,
      20,    16,    17,    16,    17,    21,    25,     4,    23,    17,
      23,    11,    12,    13,    14,    22,     8,     6,    32
};
...
{
       0,     4,     6,     7,     9,    10,    20,    27,    28,    29,
      32,    33,    35,    24,     4,    34,    36,    22,    30,     3,
       4,    12,    22,    38,    28,     0,    30,    19,    19,    19,
      38,    24,    25,    18,    22,    37,    38,    22,    38,    38,
      11,    12,    13,    14,    21,    29,    38,     4,    34,    37,
      37,    38,    16,    17,    23,     5,    37,    23,    38,    38,
      38,    38,    23,    30,    30,    30,    38,    23,    37,    37,
      29,    30,     8,    31,    29,    30,    29
};
...
#line 100 "parser.y"
														...
														ia_backpatch((yyvsp[0].backpatch).nextlist, ia_count());
...
#line 108 "parser.y"
														...
														ia_backpatch((yyvsp[-2].backpatch).nextlist, (yyvsp[-1].marker));
														(yyval.backpatch).nextlist = (yyvsp[0].backpatch).nextlist;

														if(debug) {
															fprintf(stderr,"nextlist ");
															bp_print((yyval.backpatch).nextlist);
														}
													}
...
#line 140 "parser.y"
														...
														(yyval.backpatch).nextlist = (yyvsp[-1].backpatch).nextlist;
...
#line 150 "parser.y"
														...
														ia_backpatch((yyvsp[-3].backpatch).truelist, (yyvsp[-1].marker));
														(yyval.backpatch).nextlist = bp_merge((yyvsp[-3].backpatch).falselist, (yyvsp[0].backpatch).nextlist, NULL);
...
#line 161 "parser.y"
														...
														ia_backpatch((yyvsp[-6].backpatch).truelist, (yyvsp[-4].marker));
														ia_backpatch((yyvsp[-6].backpatch).falselist, (yyvsp[-1].marker));

														bp_node* temp = (bp_node*) malloc(sizeof(bp_node));
														temp = bp_merge((yyvsp[-3].backpatch).nextlist, (yyvsp[-2].backpatch).nextlist, (yyvsp[0].backpatch).nextlist);
														(yyval.backpatch).nextlist = temp;
...
#line 176 "parser.y"
														...
														ia_backpatch((yyvsp[0].backpatch).nextlist, (yyvsp[-5].marker));
														ia_backpatch((yyvsp[-3].backpatch).truelist, (yyvsp[-1].marker));
														(yyval.backpatch).nextlist = (yyvsp[-3].backpatch).falselist;

														char* new_goto = (char*) malloc(sizeof(char) * 10);
														sprintf(new_goto, "goto %i", (yyvsp[-5].marker));
														ia_emit(new_goto);
...
#line 192 "parser.y"
														...
														(yyval.backpatch).nextlist = NULL; //controllare
													}
...
#line 207 "parser.y"
														...
														(yyval.backpatch).nextlist = bp_new(ia_count());
														ia_emit("goto ");
...
#line 219 "parser.y"
														...
														char* new_line = (char*) malloc(sizeof(char) * (strlen((yyvsp[0].address)) + 6 + 1));
														sprintf(new_line, "print %s", (yyvsp[0].address));
														ia_emit(new_line);
														free(new_line);
													}
...
#line 228 "parser.y"
														...
														int address = st_exist((yyvsp[-2].identifier));

														if(address >= 0) {
															if(trace) fprintf(stderr,"\nA->id = e [ASS]\n");

															char* new_line = (char*) malloc(sizeof(char) * (10 + 3 + strlen((yyvsp[0].address)) + 1));
															sprintf(new_line, "s%i = %s", address, (yyvsp[0].address));
															ia_emit(new_line);
															free(new_line);
														} else {
...
#line 245 "parser.y"
														...
														if(st_exist((yyvsp[-2].identifier)) < 0) {
															if(trace) fprintf(stderr,"\nA->id = e [DEC]\n");
															...
															char* new_line = (char*) malloc(sizeof(char) * (strlen(temp_label) + strlen((yyvsp[0].address)) + 3 + 1));
															sprintf(new_line, "%s = %s", temp_label, (yyvsp[0].address));
															ia_emit(new_line);
															free(new_line);

															//payload for assignment
															(yyval.assign).identifier = (yyvsp[-2].identifier);
															(yyval.assign).temp_label = (char*)temp_label; 
														} else {
...
#line 273 "parser.y"
														...
														if(st_exist((yyvsp[0].identifier)) < 0) { //check that variable does not exist

															int address = st_new((yyvsp[0].identifier),"int");
...
#line 289 "parser.y"
														...
														int address = st_new((yyvsp[0].assign).identifier,"int");
														...
														new_line = (char*) malloc(sizeof(char) * (10 + 3 + strlen((yyvsp[0].assign).temp_label) + 1));
														sprintf(new_line, "s%i = %s", address, (yyvsp[0].assign).temp_label);
														ia_emit(new_line);
														free(new_line);
													}
...
#line 335 "parser.y"
														...
														ia_backpatch((yyvsp[-3].backpatch).falselist, (yyvsp[-1].marker));
														(yyval.backpatch).truelist = bp_merge((yyvsp[-3].backpatch).truelist, (yyvsp[0].backpatch).truelist, NULL);
														(yyval.backpatch).falselist = (yyvsp[0].backpatch).falselist;

														if(debug) {
															fprintf(stderr, "propagating truelist");
															bp_print((yyval.backpatch).truelist);
															fprintf(stderr, "propagating falselist");
															bp_print((yyval.backpatch).falselist);
														}
													}
...
#line 349 "parser.y"
														...
														ia_backpatch((yyvsp[-3].backpatch).truelist, (yyvsp[-1].marker));
														(yyval.backpatch).falselist = bp_merge((yyvsp[-3].backpatch).falselist, (yyvsp[0].backpatch).falselist, NULL);
														(yyval.backpatch).truelist = (yyvsp[0].backpatch).truelist;
...
#line 363 "parser.y"
														...
														(yyval.backpatch).truelist = (yyvsp[0].backpatch).falselist;
														(yyval.backpatch).falselist = (yyvsp[0].backpatch).truelist;
...
#line 376 "parser.y"
														...
														(yyval.backpatch).truelist = (yyvsp[-1].backpatch).truelist;
														(yyval.backpatch).falselist = (yyvsp[-1].backpatch).falselist;
...
#line 389 "parser.y"
														...
														(yyval.backpatch).truelist = bp_new(ia_count());
														(yyval.backpatch).falselist = bp_new(ia_count() + 1);

														char* new_line = (char*) malloc(sizeof(char) * (3 + strlen((yyvsp[-2].address)) + 1 + strlen((yyvsp[-1].rel_op)) + 1 + strlen((yyvsp[0].address)) + 6 + 1));
														sprintf(new_line, "if %s %s %s goto ", (yyvsp[-2].address), (yyvsp[-1].rel_op), (yyvsp[0].address));
														ia_emit(new_line);
														ia_emit("goto ");
														free(new_line);
...
#line 410 "parser.y"
														...
														char* new_line = (char*) malloc(sizeof(char) * (strlen(temp_label) + 3 + strlen((yyvsp[-2].address)) + 3 + strlen((yyvsp[0].address)) + 1));
														sprintf(new_line, "%s = %s + %s", temp_label, (yyvsp[-2].address), (yyvsp[0].address));
														ia_emit(new_line); //emit: temp = e1.addr + e2.addr
														free(new_line);
														
														(yyval.address) = (char*)temp_label; //propagate synth. label
													}
...
#line 458 "parser.y"
														...
														char* new_line = (char*) malloc(sizeof(char) * (strlen(temp_label) + 3 + strlen((yyvsp[-1].address)) + 1));
														sprintf(new_line, "%s = %s", temp_label, (yyvsp[-1].address));
														ia_emit(new_line);
														free(new_line);
...
#line 470 "parser.y"
														...
														char* new_line = (char*) malloc(sizeof(char) * (strlen(temp_label) + 8 + strlen((yyvsp[0].address)) + 1));
														sprintf(new_line, "%s = minus %s", temp_label, (yyvsp[0].address));
														ia_emit(new_line);
														free(new_line);
...
#line 487 "parser.y"
														...
														int address = st_exist((yyvsp[0].identifier));

														if(address>=0) {
															sprintf((yyval.address),"s%i",address);
														} else {
															//throw error!!
														...
														(yyval.address) = (yyvsp[0].identifier);
													}
